...
st.set_page_config(layout='wide', initial_sidebar_state='expanded',page_title='Accountabillity Dashboard',theme='light')
...
if selected == 'Facturas':
    ...
    st.sidebar.markdown('''
    ---
    Created By Luis Javier Gutiérrez Márquez
    ''')
    ...
    with Columna_Principal1:
        ...
        with Graficas_Facturas:
            ...
            with Barras:
                ...
                barra['Total']=lista1
                fig=px.bar(barra,x='Factura',y='Total',color='Total',color_continuous_scale=['#22AA33','#6F6EFF','#2A3864'],width=550,height=500)
    ...
    with Columna_Principal2:
        ...
        with top_clientes:
            ...
            fig2.update_layout(margin=dict(l=150,r=5,b=40,t=40))
    ...
    with Grafica_Serie_Tiempo:
        ...
        with Todos:
            ...
            with porcentaje_aumento:
                ...
                fig3.update_layout(margin=dict(l=30,r=5,b=10,t=60),
                                  width=350,
                                  height=350)
...
if selected == 'Modelos':
    #--------------------------------------------------
    #--- SIDEBAR CONFIG ---
    st.markdown("<h2 style= 'text-align: center;color:#47669B ;'>Perfil de Cliente</h2>", unsafe_allow_html=True)
    st.markdown("---")
